...
class Disclaimer extends CI_Controller {
	...
	public function index()
	{
		...
		$data['judul_halaman'] = 'Disclaimer';
		$data['menu'] = 'disclaimer';
		$data['single_page'] = 'Disclaimer';
		$data['main_content'] = 'disclaimer/disclaimer';
		$total_artikel = $this->Disclaimer_model->total_artikel();
