...
class Teknologi_model extends CI_Model {
	...
	{
		$sql1 = $this->db->order_by('created_date', 'DESC')->get('teknologi')->result_array();
	...
	{
		$sql4 = $this->db->where('id', $id_artikel)->get('teknologi')->row_array();
	...
	{
		$sql5 = $this->db->where('id', $id_artikel+1)->get('teknologi')->row_array();
	...
	{
		$sql6 = $this->db->where('id', $id_artikel-1)->get('teknologi')->row_array();
	...
	{
		$sql7 = $this->db->order_by('id', 'RANDOM')->limit(3)->get('teknologi')->result_array();
