...
class Automotif_model extends CI_Model {
    
	public function kategori()
	{
		$sql1 = $this->db->order_by('created_date', 'DESC')->get('automotif')->result_array();
	...
	{
		$sql4 = $this->db->where('id', $id_artikel)->get('automotif')->row_array();
	...
	{
		$sql5 = $this->db->where('id', $id_artikel+1)->get('automotif')->row_array();
	...
	{
		$sql6 = $this->db->where('id', $id_artikel-1)->get('automotif')->row_array();
	...
	{
		$sql7 = $this->db->order_by('id', 'RANDOM')->limit(3)->get('automotif')->result_array();
