...
class Olahraga_model extends CI_Model {
	...
	{
		$sql1 = $this->db->order_by('created_date', 'DESC')->get('olahraga')->result_array();
	...
	{
		$sql4 = $this->db->where('id', $id_artikel)->get('olahraga')->row_array();
	...
	{
		$sql5 = $this->db->where('id', $id_artikel+1)->get('olahraga')->row_array();
	...
	{
		$sql6 = $this->db->where('id', $id_artikel-1)->get('olahraga')->row_array();
	...
	{
		$sql7 = $this->db->order_by('id', 'RANDOM')->limit(3)->get('olahraga')->result_array();
